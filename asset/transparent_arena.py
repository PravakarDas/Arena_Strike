...
def display():
    global cheer_time, camera_distance, camera_height, frame
...
def draw_camera_background():
    ...
    # Flip frame vertically and convert BGR to RGB
    flipped = cv2.flip(frame, 0)
    rgb_frame = cv2.cvtColor(flipped, cv2.COLOR_BGR2RGB)

    h, w, _ = rgb_frame.shape

    # Bind texture and upload frame as texture
...
def main():
    ...
    glutCreateWindow(b"AR Football Arena")
    ...
    print("Running AR Arena... Press ESC to quit.")
