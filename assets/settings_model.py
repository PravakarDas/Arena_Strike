...
def main():
    ...
    print("   [3] ➤ Quit Game")
    print("")
    print("⚙️  SETTINGS NAVIGATION:")
    print("   Settings Menu:")
    print("     [1] ➤ Sound Settings (On/Off)")
    print("     [2] ➤ SFX Settings (On/Off)")
    print("     [3] ➤ Playing Mode (Easy/Hard)")
    print("   Sub-menus:")
    ...
    print(f"   🎵 SFX: {'ON' if sfx_enabled else 'OFF'}")
    print(f"   🎯 Mode: {playing_mode}")
    print("="*60)
